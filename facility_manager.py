...
class FacilityManager:
    ...
    def get_occupancy_summary(self):
        ...
        for spot in self.spots:
            ...
            elif spot["status"] == "OUT_OF_SERVICE":
                out_of_service += 1

            if spot["spot_type"] == "REGULAR":
                regular += 1

            elif spot["spot_type"] == "HANDICAPPED":
                handicapped += 1

            elif spot["spot_type"] == "EV":
                ev += 1
        ...
        return {
            ...
            "out_of_service_spots": out_of_service,
            "regular_spots": regular,
            "handicapped_spots": handicapped,
            "ev_spots": ev
        }
    ...
    def end_parking(
        ...
        for item in self.spots:
            ...
            if item["spot_id"] == session.spot_id:
